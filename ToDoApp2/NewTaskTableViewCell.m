...
//    
//    [UITableViewCell animateWithDuration:1.f
//                     animations:^
//     {
//
//         UIView *view = [[self.contentView superview] superview];
//         [view addSubview:self.blinkLabel];
//         [self.contentView bringSubviewToFront:self.blinkLabel];
//         self.blinkLabel.alpha = 0;
//
//        
//     }
