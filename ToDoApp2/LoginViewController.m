...
- (void)viewDidLoad {
    ...
    [self.login setBackgroundColor:[UIColor colorWithRed:0/255.0f green:221/255.0f blue:132/255.0f alpha:1.0f]];
...
//    self.getPassword.leftViewMode = UITextFieldViewModeAlways;
    ...
    self.line1.backgroundColor = [UIColor colorWithRed:31/255.0f green:33/255.0f blue:86/255.0f alpha:1.0f];
